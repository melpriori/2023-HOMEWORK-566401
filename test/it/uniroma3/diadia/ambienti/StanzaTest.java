...
public class StanzaTest {
	...
	/**
	 *  Controlla se l'attrezzo è stato aggiunto correttamente, e lo dimostra nel messaggio allegato al metodo
	 */
	@Test
	...
	public void testRemoveAttrezzo() {
		...
		assertTrue(this.stanza.toString(), this.stanza.removeAttrezzo(this.attrezzo));
	}
